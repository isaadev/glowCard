    ...
    >
      ...
      >
        <div className="text-center">
          <p className="text-xl text-blue-600 mb-14">Game</p>
          <p className="text-xs pt-3">Enter your Player Identifier:</p>
          <input
            type="text"
            id="player-identifier-box"
            placeholder="abc..."
            className="text-center my-6 text-xs text-gray-600 rounded-2xl bg-white border-2 border-gray-600 p-4 w-full sm:w-auto sm:flex-grow"
          />
          <div>
            <button
              id="nextBtn"
              className="rounded-2xl border-2 border-orange-400 text-orange-400 p-btnpad text-sellerTxt "
            >
              Next >
            </button>
          </div>
